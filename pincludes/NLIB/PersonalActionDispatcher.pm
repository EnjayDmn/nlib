package NLIB::PersonalActionDispatcher;

#
# $Id: PersonalActionDispatcher.pm,v 1.2 2013-12-18 12:25:50 nils-1327 Exp $
#
...
<a href="index.html#NLIB-PersonalActionDispatcher">All Classes</a>

=end html

=head1 NAME

NLIB::PersonalActionDispatcher

=head1 SYNOPSIS

B<construction:>

 my $obj = new NLIB::PersonalActionDispatcher (%params);
...
NLIB::PersonalActionDispatcher represents a default action dispatcher for a personalized and action based session flavour type. This object is meant to be an interface for inherited objects.

The dispatcher implements the handling for the type NLIB_SESSION_FLAVOUR_PERS_ACT.
